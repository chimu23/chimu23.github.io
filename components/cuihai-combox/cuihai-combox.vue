	...
	<view class="uni-combox">
		...
		<view class="uni-combox__input-box">
			<input class="uni-combox__input" type="text" :placeholder="placeholder" :disabled="isDisabled" v-model="inputVal"
			 @input="onInput" @focus="onFocus" @confirm="endInput" />
			<!-- <input class="uni-combox__input" type="text" :placeholder="placeholder" :disabled="isDisabled" v-model="inputVal"
			  @input="onInput" @blur="onBlur" @confirm="endInput" /> -->
			<!-- <icon type="clear" class="xicon" size="16" @tap="clearInputValue" v-if="!isDisabled" /> -->
			...
			<text :class="['icon-menu toggle-icon', showSelector?'toggle-icon_active':'']" @tap="toggleSelector"></text>
...
<style lang="scss" scoped>
	...
	.uni-combox__selector {
		...
		border-radius: 6px;
		// box-shadow: map-get($map: $colors, $key: purple-100) 4px 4px 8px, map-get($map: $colors, $key: purple-100) -4px -4px 8px;
		z-index: 2;
	}
	...
	.uni-combox__selector-item {
		...
		font-size: 14px;
		text-align: center;
		// border-bottom: solid 1px map-get($map: $colors, $key: purple-100);
		/* margin: 0px 10px; */
	}
